        ...
        <div id="errorMessage"></div>
          ...
          <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-4 col-md-offset-3">
                <p><input required type="password"  id ="passwordConfirm" name="passwordConfirm" size="30" ></p>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-5 col-md-offset-3">
                  <p><input required type="date" id="staticiBrthday" name = "staticiBrthday" size="30" value = "${user.birthDate}"></p>
                </div>
            </div>


            <div style="margin-left:38%;margin-right:38%;">
             <input type="submit" style="width:90%;padding:10px;font-size:15px;" value="更新" onClick="location.href='UserListServlet'"/>
           </div>
